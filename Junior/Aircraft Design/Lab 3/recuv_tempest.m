...
aircraft_parameters.IW = [0;0;aircraft_parameters.W];
...
% Drag terms
aircraft_parameters.e = 0.95; %[-], AVL, Oswald's efficiency factor
...
aircraft_parameters.CLalpha = [6.196683]; %STUDENT COMPLETED
aircraft_parameters.Cmalpha = [-1.634010]; %STUDENT COMPLETED
aircraft_parameters.CLq = [10.137584]; %STUDENT COMPLETED
aircraft_parameters.Cmq = [-24.376066]; %STUDENT COMPLETED
...
aircraft_parameters.CYbeta = [-0.367231]; %STUDENT COMPLETED
aircraft_parameters.Clbeta = [-0.080738]; %STUDENT COMPLETED
aircraft_parameters.Cnbeta = [0.080613]; %STUDENT COMPLETED
aircraft_parameters.CYp = [-0.064992 ]; %STUDENT COMPLETED
aircraft_parameters.Clp = [-0.686618]; %STUDENT COMPLETED
aircraft_parameters.Cnp = [-0.039384]; %STUDENT COMPLETED
aircraft_parameters.Clr = [0.119718]; %STUDENT COMPLETED
aircraft_parameters.Cnr = [-0.052324]; %STUDENT COMPLETED
aircraft_parameters.CYr = [0.213412]; %STUDENT COMPLETED

%Control surface deflection parameters

  % Elevator
  aircraft_parameters.CLde =  [0.006776]; %STUDENT COMPLETED
  aircraft_parameters.Cmde =  [-0.028684]; %STUDENT COMPLETED
  % Aileron
  aircraft_parameters.CYda =  [-0.000754]; %STUDENT COMPLETED
  aircraft_parameters.Clda =  [-0.006290]; %STUDENT COMPLETED
  aircraft_parameters.Cnda =  [-0.000078]; %STUDENT COMPLETED
 
  % Rudder
  aircraft_parameters.CYdr =  [0.003056]; %STUDENT COMPLETED
  aircraft_parameters.Cldr =  [0.000157]; %STUDENT COMPLETED
  aircraft_parameters.Cndr =  [-0.000856]; %STUDENT COMPLETED
