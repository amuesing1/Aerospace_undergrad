function [distance,t,y] = DistanceObjectiveNoAir(initialValues)
...
initialValues = [initialValues(6), angle, 0, 0.01, data.mRI, data.vairI, 0, 0];
opts = odeset('RelTol',1e-8,'AbsTol',1e-9);
[t,y] = ode45(@TrajectoryNoAir,startStop,initialValues,opts,data);
