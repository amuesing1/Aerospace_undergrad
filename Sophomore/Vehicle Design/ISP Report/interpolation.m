function [ thrust ] = interpolation( data )
...
%creating new time array starting from 0 to end column
size_time=col2-col1;
for i=1:size_time+1
    new_time(i)=i*time_int;
end

% creating thrust value array
thrust=[new_time' force(col1:col2)];
end
